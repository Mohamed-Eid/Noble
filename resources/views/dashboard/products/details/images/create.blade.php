<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title" style="margin-bottom: 10px;">@lang('site.images')</h3>
        </div>
        ...
        <form action="{{ route('dashboard.products.details.upload_images', ['product' => $product]) }}" class="dropzone" method="post">
            @csrf
        </form>
