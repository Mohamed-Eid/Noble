                    ...
                    @foreach($coupons as $index => $coupon)
                        <tr>
                            ...
                            <td>
                                ...
                                href="{{route('dashboard.products.details.edit_coupons' , ['product' => $coupon->product, 'coupon'=>$coupon])}}"><i
                                ...
                                <form method="post"
                                    action="{{route('dashboard.products.details.delete_coupons' , ['product' => $coupon->product, 'coupon'=>$coupon])}}"
