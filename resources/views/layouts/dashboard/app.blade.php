...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ asset('dashboard/plugins/select2/dist/css/select2.min.css') }}">
    @if (app()->getLocale() == 'ar')
...
<!-- Select2 -->
<script src="{{ asset('dashboard/plugins/select2/dist/js/select2.full.min.js') }}"></script>
...
<!--<script scr="{{ asset('dashboard/plugins/print_this/printThis.js') }}"></script>-->
